...
class DESEQ2Runner:
    ...
    def run_deseq2(self):
        ...
        return {
                "volcano_path": "/Data/DGA/{0}/{1}/{2}_DESeq2_MA.png".format(self.species, self.job_id, self.species),
                "ma_path": "/Data/DGA/{0}/{1}/{2}_DESeq2_Volcano.png".format(self.species, self.job_id, self.species)
        }
...
class EDGERRunner:
    ...
    def run_edgeR(self):
        ...
        return {
                "volcano_path": "/Data/DGA/{0}/{1}/{2}_edgeR_Volcano.png".format(self.species, self.job_id, self.species),
                "ma_path": "/Data/DGA/{0}/{1}/{2}_edgeR_MA.png".format(self.species, self.job_id, self.species)
        }
    def check_cache(self):
        """檢查是否有現成的圖片，若有則回傳網址路徑"""
        # 定義預期的檔名
...
if __name__ == "__main__":
    ...
    selected_columns = [{'stat': 'unselected', 'col': 'Root'}, {'stat': 'unselected', 'col': 'Column'}, {'stat': 'control', 'col': 'Floral'}, {'stat': 'control', 'col': 'Flower'}, {'stat': 'comparison', 'col': 'Leaf'}, {'stat': 'unselected', 'col': 'Lip'}, {'stat': 'unselected', 'col': 'NodeLeaf'}, {'stat': 'unselected', 'col': 'Pollinia'}, {'stat': 'unselected', 'col': 'Sepal'}, {'stat': 'unselected', 'col': 'Stem'}]
